...
Implement the first executable token-tree macro subset by routing macro output through one audited reparse boundary before notation/type/lowering acceptance.
...
- `crates/ash-parser/tests/task_1767_token_tree_expansion.rs`
