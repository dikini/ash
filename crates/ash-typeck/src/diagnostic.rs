    ...
    fn span(&self) -> Option<Span> {
        Some(
            match self {
                ...
                Self::UnsupportedSummaryVersion { span, .. } => span,
                Self::MalformedImportedComputationSummary { span, .. } => span,
                Self::MalformedImportedEffectRowSummary { span, .. } => span,
                Self::PrivateDependencyExportFailure { span, .. } => span,
                Self::ImportOrderConflict { span, .. } => span,
                Self::UnknownPropositionPredicate { span, .. } => span,
                Self::PropositionPredicateArityMismatch { span, .. } => span,
                Self::PropositionDiagnostic { span, .. } => span,
                Self::DuplicateCallableRow { span, .. } => span,
                Self::RowTailNotFinal { span, .. } => span,
                Self::DuplicateRowTail { span, .. } => span,
                Self::UnsupportedRowItemFamily { span, .. } => span,
                Self::InterfaceQualifiedOperationRowIdentity { span, .. } => span,
                Self::UnknownOperationRowImplType { span, .. } => span,
                Self::UnknownOperationRowMethod { span, .. } => span,
    ...
    fn code(&self) -> Option<DiagnosticCode> {
        Some(DiagnosticCode(
            match self {
                ...
                Self::UnsupportedSummaryVersion { .. } => "E133",
                Self::MalformedImportedComputationSummary { .. } => "E134",
                Self::MalformedImportedEffectRowSummary { .. } => "E134",
                Self::PrivateDependencyExportFailure { .. } => "E135",
                Self::ImportOrderConflict { .. } => "E136",
                Self::UnknownPropositionPredicate { .. } => "E166",
                Self::PropositionPredicateArityMismatch { .. } => "E167",
                Self::PropositionDiagnostic { kind, .. } => kind.code(),
                Self::DuplicateCallableRow { .. } => "E178",
                Self::RowTailNotFinal { .. } => "E179",
                Self::DuplicateRowTail { .. } => "E180",
                Self::UnsupportedRowItemFamily { .. } => "E181",
                Self::InterfaceQualifiedOperationRowIdentity { .. } => "E182",
                Self::UnknownOperationRowImplType { .. } => "E183",
                Self::UnknownOperationRowMethod { .. } => "E184",
...
impl AshLspError for crate::solver::TypeError {
    fn span(&self) -> Option<Span> {
        match self {
            ...
            Self::UnknownVariantForCanonicalType { span, .. } => Some((*span).into()),
    ...
    fn code(&self) -> Option<DiagnosticCode> {
        Some(DiagnosticCode(
            match self {
                ...
                Self::UnknownVariantForCanonicalType { .. } => "E154",
