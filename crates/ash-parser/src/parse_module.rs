...
use crate::surface::{
    ...
    PropositionTail, PropositionWhereRow, ProxyDef, RawOperatorToken, ResourceField,
    ResourceTypeDef, RoleDef, RowPathSeparator, SealedDomainDef, Type, TypeBody, TypeDef,
