...
| [TASK-2072](tasks/TASK-2072-parsed-import-resolution-and-atomic-binding.md) | Resolve all parsed imports from the name view and publish atomic bindings | In progress — partial/none/below-spec; active owner for parsed imports, visibility, precedence, cycles, and atomic binding |
