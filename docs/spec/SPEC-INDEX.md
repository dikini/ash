...
### Grammar or surface syntax work
...
3. Relevant design notes tagged `grammar` in [NOTE-INDEX](../notes/NOTE-INDEX.md).
...
### Target effect/type/IR planning
...
| [SPEC-095b-TARGET-GRAMMAR.md](SPEC-095b-TARGET-GRAMMAR.md) | draft | language-surface | grammar, surface, target-state | target-state spec | NOTE-015; NOTE-021; parser plans/tasks |
...
| [SPEC-098b-TARGET-IR.md](SPEC-098b-TARGET-IR.md) | draft | core-ir | core-ir, semantics, target-state | target-state spec | SPEC-099; SPEC-100; PLAN-165 |
...
| [SPEC-099b-TARGET-OPERATIONAL-SEMANTICS.md](SPEC-099b-TARGET-OPERATIONAL-SEMANTICS.md) | draft | core-ir | core-ir, semantics, target-state | target-state spec | — |
