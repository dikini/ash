...
- **Structural-module closure:** Public and private child-module declarations retain checked canonical child identities in the structural-module namespace; private children remain outside the external projection. Positive evidence is `TEST-MOD-REAL-003-TASK-2073-PUBLIC-STRUCTURAL-MODULE-FACT` and `TEST-MOD-REAL-003-TASK-2073-PRIVATE-STRUCTURAL-MODULE-FACT`. This is Type-layer, non-authorizing evidence.
