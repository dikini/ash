    ...
    def test_task_2035_scope_and_documentation_verification_are_controlled(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            payload["active_scope"] = {
                "kind": "task-2065-module-realization-closeout",
                "tasks": sorted(TASK_2065_MODULE_REALIZATION_CLOSEOUT_SCOPE),
            }
            payload["active_tasks"] = sorted(TASK_2065_MODULE_REALIZATION_CLOSEOUT_SCOPE)
