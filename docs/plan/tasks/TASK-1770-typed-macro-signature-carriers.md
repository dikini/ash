...
Add syntax carriers for typed macro parameters/results and preserve them through summaries/imports without accepting unchecked templates.
...
- `crates/ash-parser/tests/task_1770_typed_macro_signature_carriers.rs`
