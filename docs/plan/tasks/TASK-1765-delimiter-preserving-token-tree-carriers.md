...
Replace raw bracket/brace diagnostic text with structured delimiter/token-tree carriers suitable for future execution and hygiene diagnostics.
...
- `crates/ash-parser/tests/task_1765_macro_token_tree_carriers.rs`
