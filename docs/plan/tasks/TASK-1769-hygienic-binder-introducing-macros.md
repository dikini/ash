...
Allow a narrow expression-local binder-introducing macro subset once TASK-1768 proves hygiene metadata, while keeping generated definitions/modules out of scope.
...
- `crates/ash-engine/tests/task_1769_binder_macro_boundaries.rs`
