...
| [SPEC-099b-TARGET-OPERATIONAL-SEMANTICS.md](SPEC-099b-TARGET-OPERATIONAL-SEMANTICS.md) | draft; §5 selects source-ordered deep affine handlers over the historical shallow rule | core-ir | core-ir, effect-system, runtime, semantics, target-state | target-state spec | SPEC-098b; SPEC-098c; SPEC-100; SPEC-101; TASK-2013; TASK-2014; PLAN-167; PLAN-195 |
