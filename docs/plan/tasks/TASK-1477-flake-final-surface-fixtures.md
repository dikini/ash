...
Create Ash fixtures proving retry classification and quarantine reporting through direct `$ASH_UNDER_TEST test ...`.
...
- TASK-1476 complete or explicitly handed off
