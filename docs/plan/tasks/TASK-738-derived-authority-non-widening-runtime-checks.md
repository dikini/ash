# TASK-738: Enforce derived-authority non-widening checks for adapter/decorator capability bindings.
...
Enforce derived-authority non-widening checks for adapter/decorator capability bindings.
...
1. Preserve links to inner capability bindings and resources.
2. Reject derived bindings that expose operations outside their interface.
3. Reject dependency-free external authority claims.
4. Record provenance chains for derived operations.
...
- Derived capability bindings are auditable and non-widening.
