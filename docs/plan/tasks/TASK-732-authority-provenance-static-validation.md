    # TASK-732: Add static validation for host, internal, and derived authority provenance declarations.
    ...
    Add static validation for host, internal, and derived authority provenance declarations.
...
- SPEC-017
    ...
    1. Classify binding authority as host, internal, or derived where statically knowable.
2. Reject obvious external-authority manufacture by Ash-defined implementations.
3. Require derived implementations to declare all authority dependencies.
4. Record provenance metadata for runtime admission.
    ...
    - Static checks prevent authority-source omissions before runtime.
