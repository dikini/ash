...
### Added
- Phase-judgment and rejection-boundary tightening for TASK-178. [SPEC-001](docs/spec/SPEC-001-IR.md), [SPEC-003](docs/spec/SPEC-003-TYPE-SYSTEM.md), [SPEC-004](docs/spec/SPEC-004-SEMANTICS.md), and [docs/reference/type-to-runtime-contract.md](docs/reference/type-to-runtime-contract.md) now separate parser, lowering, type, runtime, and observable-behavior rejection classes from canonical contract text.
