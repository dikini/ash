...
the 5/5 canonical-keyed Engine carrier fence is delivered, while lowerer wiring for remaining
namespace/dependency facts, scanner/cache fencing, and parity remain separately open.
