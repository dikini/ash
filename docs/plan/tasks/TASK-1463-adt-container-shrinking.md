...
Add Option/Result/List shrinking by constructor simplification, length reduction, and recursive payload shrinking.
...
- TASK-1462 complete or explicitly handed off
