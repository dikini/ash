...
| [SPEC-071](SPEC-071-REFERENCE-CORPUS-METADATA-AND-MAINTENANCE.md) | Reference Corpus Metadata and Maintenance | Draft | Metadata, authority, crosslinking, lifecycle, tone, agent-derivative, static-validation, and maintenance rules for the separate top-level `reference/` corpus while preserving `docs/` as working and historical documentation. |
