...
| [TASK-2069](tasks/TASK-2069-complete-module-lowering-and-engine-transport-fencing.md) | Implement complete definition-body lowering and Engine scanner/path-cache transport fencing | In progress — partial/tested/below-spec; bounded finalized-body and atomic per-function closure lowering are delivered; resolved-import/dependency transport and Engine fencing remain open; consumes TASK-2073 and is the immediate TASK-2063 prerequisite |
