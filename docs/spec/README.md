...
| [SPEC-058](SPEC-058-CANONICAL-TYPE-EXPRESSION-IR-PROJECTION-IDS-KIND-ARITY-SUBSTRATE.md) | Canonical Type-Expression IR, Projection Identities, and Kind/Arity Substrate | Draft | DESIGN-034 SPEC-B: internal type-expression substrate promoting canonical computation-grade identities, canonical projection IR, rigid/neutral carriers, and explicit kind/arity validation while keeping `type fn`, sealed domains, normalization, computation-summary export/import, and new public syntax deferred. |
