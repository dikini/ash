...
| [TASK-2075](tasks/TASK-2075-two-tier-complete-module-collection.md) | Collect internal snapshots and name-only provisional views | In progress — partial/tested/below-spec; Tasks 5–7 deliver graph-wide atomic paired collection, exhaustive namespaces/coherence, expanded raw definitions/bodies, nested member spans, direct source anchors/ordinals, module sidecars, exact strict provisional view, and keyed/span-anchored SourceDrift revalidation (32/32); normalized collected file/inline projection, generated/property, compatibility, complete authority fencing, and imported-interface binding remain | prerequisite |
