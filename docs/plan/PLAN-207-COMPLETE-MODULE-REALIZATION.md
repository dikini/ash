...
| [TASK-2074](tasks/TASK-2074-canonical-expanded-module-graph.md) | Build the AST-only syntax prepass and canonical expanded graph | In progress — partial/tested/below-spec local-only shallow graph; syntax prepass, topology/cycles, imported notation, parity, and authority fences remain | prerequisite |
