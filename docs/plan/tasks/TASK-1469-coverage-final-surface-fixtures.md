...
Create Ash fixtures where one law is covered and one is uncovered; verify direct `$ASH_UNDER_TEST test --coverage ...` output.
...
- TASK-1468 complete or explicitly handed off
