...
Implement bounded Option, Result, and List generation with size/depth limits and explicit unsupported-domain deferrals.
...
- TASK-1458 complete or explicitly handed off
