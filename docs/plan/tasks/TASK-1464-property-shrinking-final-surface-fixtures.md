...
Add direct `$ASH_UNDER_TEST test ...` positive and negative fixtures proving generated cases and shrunk counterexamples work without Cargo.
...
- TASK-1463 complete or explicitly handed off
