...
Recognize quarantine directives/files, mark quarantined tests separately, and fail closed on malformed quarantine entries.
...
- TASK-1475 complete or explicitly handed off
