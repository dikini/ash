...
Add coverage categories for discovered laws, proofs, authored tests, property evidence, small-world rows, and unexercised declarations.
...
- TASK-1466 complete or explicitly handed off
