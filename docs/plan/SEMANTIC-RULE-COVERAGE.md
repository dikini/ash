...
- **Updated focused target:** The qualified namespace, implementation-call, where-bound, transitive-row, callable-whole-row, role-row, policy-row, and binding-metadata RED/GREEN slices bring the focused TASK-2073 target to 90/90.
