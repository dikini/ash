...
TASK-2073 consumes the former plus TASK-2072 staging. TASK-2074 now has only an expected-RED test;
no production Rust, passing semantic evidence, or runtime evidence exists.
