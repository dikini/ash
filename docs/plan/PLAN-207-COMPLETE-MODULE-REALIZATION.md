...
| [TASK-2075](tasks/TASK-2075-two-tier-complete-module-collection.md) | Collect internal snapshots and name-only provisional views | In progress — partial/tested/below-spec; visibility/carrier prerequisites plus Task 5 graph-wide atomic paired collection, exhaustive namespaces, parent-aware collisions/members/constructors, typed notation keys/diagnostics, and full impl-head coherence delivered; drift, collected file/inline projection, generated-name/property, compatibility, complete raw facts, and authority-fence evidence remain | prerequisite |
