...
Add runner configuration for retry counts, deterministic seeds, failure signatures, and flake classification metadata.
...
- TASK-1474 complete or explicitly handed off
