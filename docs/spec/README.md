...
| [SPEC-077](SPEC-077-ASH-TEST-RUNNER-SYNTHESIZED-AND-SMALLWORLD-COMPLETION.md) | Ash Test Runner Synthesized and Small-World Completion | Draft | Defines the follow-on DESIGN-022/DESIGN-023 completion work after Phase 76B: live checked/lowered runner snapshots from ordinary CLI files, end-to-end synthesized contract/policy/obligation execution, deterministic small-world target execution, richer finite domains, CLI integration, repro artifacts, and broad verification. |
