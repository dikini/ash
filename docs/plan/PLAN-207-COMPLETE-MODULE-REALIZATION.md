...
| [TASK-2075](tasks/TASK-2075-two-tier-complete-module-collection.md) | Collect internal snapshots and name-only provisional views | In progress — partial/tested/below-spec; visibility plus private carrier/domain/fence boundary delivered, graph collector/publication absent | prerequisite |
