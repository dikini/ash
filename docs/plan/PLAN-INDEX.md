...
| [TASK-2069](tasks/TASK-2069-complete-module-lowering-and-engine-transport-fencing.md) | Implement complete definition-body lowering and Engine scanner/path-cache transport fencing | In progress — partial/none/below-spec; activated with a red lowering/transport contract; consumes TASK-2073 and is the immediate TASK-2063 prerequisite |
