...
| [NOTE-009-CAPABILITY-INTERFACES-IMPLEMENTATIONS-AND-INTERNAL-AUTHORITY.md](NOTE-009-CAPABILITY-INTERFACES-IMPLEMENTATIONS-AND-INTERNAL-AUTHORITY.md) | Exploratory design note | ambient-computation | authority, effect-system | design note | — |
| [NOTE-010-WORKFLOW-FORM-PRECHECK-QUESTIONS.md](NOTE-010-WORKFLOW-FORM-PRECHECK-QUESTIONS.md) | Exploratory / Q&A backlog with initial decisions | workflow | type-system, workflow | design note | — |
...
| [NOTE-020-COMPUTATION-ROW-TAXONOMY.md](NOTE-020-COMPUTATION-ROW-TAXONOMY.md) | Draft note -- taxonomy and terminology refinement | ambient-computation | effect-system | design note | — |
