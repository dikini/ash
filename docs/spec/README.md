...
| [SPEC-059](SPEC-059-SEALED-TYPE-LEVEL-DOMAINS.md) | Sealed Type-Level Domains | Draft | DESIGN-034 SPEC-C: introduces nominal sealed type-level domains, marker-constructor identities, domain-kind metadata, and visibility-aware public domain-summary transport while deferring normalization, direct structural `type fn`, associated type families, and promoted data constructors. |
