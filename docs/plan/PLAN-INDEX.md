...
| [TASK-2031](tasks/TASK-2031-lambda-ash-effect-correspondence.md) | Define complete `λAsh-Effect` CPS/operational/Rust correspondence before effectful executor expansion | In progress |
...
| [TASK-2031B](tasks/TASK-2031B-lexical-scope-admission-contract-reconciliation.md) | Reconcile stale lexical-scope CLI rejection assertions with bounded checked Core-to-CPS admission | In progress (bounded test-contract remediation) |
...
| [TASK-2031E](tasks/TASK-2031E-stdlib-corpus-test-isolation.md) | Isolate mutable LLM import fixtures from the canonical stdlib corpus tree | In progress (bounded test-isolation remediation) |
| [TASK-2031F](tasks/TASK-2031F-stdlib-admission-contract-reconciliation.md) | Reconcile stale stdlib callable admission-message assertions with the bounded PureAnf bridge | In progress (bounded test-contract remediation) |
