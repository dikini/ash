...
Store interface constraints in TypeEnv and enforce required evidence for concrete impl registration.
...
- Depends on TASK-1040 and TASK-1041 completion.
...
- Primary TypeEnv files: `crates/ash-typeck/src/type_env.rs` plus related proposition/evidence helpers if needed.
- Add focused typeck test binary: `crates/ash-typeck/tests/task_1042_interface_constraint_registration.rs`.
- Validate required evidence before recording concrete impl assumptions or pushing the new impl scheme.
