...
| [TASK-2075](tasks/TASK-2075-two-tier-complete-module-collection.md) | Collect internal snapshots and name-only provisional views | In progress — not_implemented/none/below-spec; active Type-layer owner for the internal snapshot and name-only provisional view | prerequisite |
