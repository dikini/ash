...
| [SPEC-062](SPEC-062-MODULE-SUMMARY-EXPORT-IMPORT-FOR-TYPE-COMPUTATION.md) | Module-Summary Export/Import for Type Computation | Draft | DESIGN-034 SPEC-F: planned public module-summary boundary for type computation, exporting/importing public sealed-domain and transparent public `type fn` summaries through core-owned semantic summaries while preserving private equation opacity, import-order independence, summary versioning, and normalizer non-inversion. |
