...
| [TASK-1504](tasks/TASK-1504-quickcheck-seed-replay-and-aggregate-evidence.md) | Implement random seed default, external replay override, source-seed linting, run records, aggregate pass history, sticky errors, and active findings. | 📝 Planned |
| [TASK-1505](tasks/TASK-1505-quickcheck-v1-final-surface-fixtures-and-docs.md) | Add no-Cargo final-surface fixtures and user docs for ordinary strategies, overrides, recursion, shrinking, seeds, and evidence history. | 📝 Planned |
