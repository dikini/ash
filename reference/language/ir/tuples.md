...
This is an internal representation rule. Execution is available only through an admitted request
to `Engine`, with CPS validation and evaluation retained in the Engine-private kernel.
