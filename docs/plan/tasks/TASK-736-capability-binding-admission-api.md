# TASK-736: Add runtime admission APIs for capability bindings selected by workflow/process/run headers.
...
Add runtime admission APIs for capability bindings selected by workflow/process/run headers.
...
1. Create capability binding runtime carriers.
2. Admit host-backed primitive bindings without changing existing providers.
3. Admit implementation-backed bindings with dependency records.
4. Project admitted bindings into Act/Proc/Workflow runtime contexts.
...
- Runtime has explicit admitted capability bindings.
