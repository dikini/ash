...
- **Frozen Phase 207 implementation:** implemented
- **Frozen Phase 207 evidence:** tested
- **Frozen Phase 207 parity:** matches_spec
- **Frozen Phase 207 layers:** Type, Core, CPS, admission/runtime, and verification implemented
  for the ordinary callable route; non-callable metadata remains non-authorizing.
- **Frozen Phase 207 missing clauses:** None. Every public declaration required by an importing
  callable survives identity/origin/visibility/checked-metadata propagation; unsupported or
  incomplete forms reject before authority. Bodyless builtin host dispatch, raw synthesized-pattern
  compatibility APIs, dynamic loading, package resolution, incremental workspaces, generalized
  macro/runtime behavior, and role/policy authority are explicit exclusions.
- **Historical broader target:** The original complete-language MOD-REAL rule remains broader than
  this frozen completion domain. Its old partial/below-spec handoff descriptions are retained in
  the task records as history and must not be read as Phase 207 blockers.
- **Historical handoffs:** TASK-2057 delivered tested AST-derived structural declarations;
  TASK-2058 delivered a tested Core `ModuleKey`/`ModuleArtifact` carrier; the following inventory
  preserves the broader pre-closeout dependency map.
  TASK-2057 has delivered tested AST-derived structural declarations; TASK-2058 has
...
fencing. TASK-2063 now supplies a bounded Engine-sealed linked request with focused admission
  evidence, while TASK-2064 owns bounded conformance/client parity and the remaining real-program
  integration. TASK-2065 owns closeout.

- **Frozen route handoffs:** TASK-2073, TASK-2069, TASK-2063, TASK-2064, and TASK-2065 are
  complete for the frozen callable domain. Public importer-needed declarations propagate through
  checked finalization/import transport; ordinary callable bodies cross Core/CPS; Engine admission
  seals the checked closure; and CLI/daemon parity is recorded. No role/policy authority, raw
  synthesized-pattern authority, dynamic loading, package resolution, incremental workspace, or
  generalized macro/runtime behavior is required.
...
The following ownership table is a historical handoff map. Current status for the five Phase 207
route owners is recorded in the dedicated sections below and is complete for the frozen domain.

| Historical target clauses | Historical owner / status | Consumes | Produces | Downstream / integration proof |
|---|---|---|---|---|
...
- **Task:** [TASK-2069](tasks/TASK-2069-complete-module-lowering-and-engine-transport-fencing.md)
- **Canonical owner:** `SPEC-103`, `MOD-REAL-005`, and traceability rule
  `SEM-MODULE-REALIZATION-005`
...
signature/identity/visibility metadata only; host builtin dispatch/runtime semantics and raw
synthesized-pattern compatibility APIs are explicitly outside the frozen completion domain.
- **Evidence detail:** positive `TEST-MOD-REAL-005-FULL-DEFINITION-BODY-LOWERING` covers one
  ...
  collected body; `TEST-MOD-REAL-005-PARAMETERIZED-BODY-LOWERING` covers finalized parameter
  names and checked signature types entering the Core value environment; and
  `TEST-MOD-REAL-005-IMPORTED-CALL-LOWERING` covers a resolved imported callable application,
  including as a nested operand of a primitive expression, reaching checked Core/CPS lowering;
  `TEST-MOD-REAL-005-IMPORTED-BUILTIN-CALLABLE-TRANSPORT` covers a bodyless imported builtin
  retained as callable metadata without inventing a body; `TEST-MOD-REAL-005-HANDLER-BODY-LOWERING`
  covers checker-retained facts for a bounded one-clause source handler lowered to checked Core
  `Handle`/CPS forms without installing provider or runtime authority;
  `TEST-MOD-REAL-005-PARENT-SCOPED-CALLABLE-FENCE` covers parent-scoped implementation methods and
  handlers retaining checked private facts while remaining outside the standalone module-entry
  lowering closure;
  `TEST-MOD-REAL-005-REACHABLE-DEPENDENCY-CLOSURE` covers transitive canonical import reachability
  carried into the Core/CPS dependency snapshot, with deterministic ordering and no duplicate
  module entries;
  `TEST-MOD-REAL-005-SELECTED-ENTRY-CLOSURE` covers explicit root-entry selection with
  metadata-only child closure transport
  before Engine transport, and `TEST-MOD-REAL-005-SELECTED-ENTRY-SELECTION-ATOMICITY` covers
  rejection when a finalized module has no selected entry; `TEST-MOD-REAL-005-ROUTE-CLOSURE-METADATA-CARRIER`
  covers the route-specific handoff retaining checked callable siblings while adding a neutral
  carrier for an unselected structural child; `TEST-MOD-REAL-005-ENGINE-CANONICAL-SOURCE-ROUTE`
  executes file-backed and inline structural children through the production canonical source
  route, checked admission, and checked CPS; positive
  `TEST-MOD-REAL-005-NEUTRAL-NONROOT-SELECTION` proves that only the root receives a selected
  route entry while non-root callable modules retain all checked callable bodies as local import
  entries and use a neutral module carrier, avoiding declaration-order selection authority;
  `TEST-MOD-REAL-005-SUPPLIED-ROOT-SOURCE-AUTHORITY` proves that the canonical graph uses the
  caller-supplied root source snapshot and cannot replace it with a second filesystem read;
  negative `TEST-MOD-REAL-005-SELECTED-ENTRY-PARENT-SCOPED-REJECTION` covers rejection of a
  parent-scoped interface/implementation member selected as though it were a standalone entry;
  negative `TEST-MOD-REAL-005-SINGLE-BODY-PARENT-SCOPED-REJECTION` covers the same non-standalone
  boundary through the single-definition lowering API;
  negative `TEST-MOD-REAL-005-BODY-LOWERING-REJECTION` covers unsupported body syntax and a
  missing checked definition; `TEST-MOD-REAL-005-PARSEABLE-CALLABLE-LOWERING-FAIL-CLOSED` covers
  parseable callable roots rejecting at the canonical boundary instead of returning to a legacy
  evaluator; `TEST-MOD-REAL-005-SELECTED-ENTRY-CALLABLE-CYCLE-FENCE` covers
  `TEST-MOD-REAL-005-PARSEABLE-CALLABLE-IMPORT-FAIL-CLOSED`, which applies the same boundary to
  canonical import-resolution failures;
  recursive same-module selected-entry aliases rejecting at the Engine callable-cycle fence;
  positive `TEST-MOD-REAL-005-IMPORT-TRANSPORT` covers aliased
  callable import identity/origin propagation into Core/CPS; `TEST-MOD-REAL-005-REPRESENTABLE-IMPORT-TRANSPORT`
  covers lossless type import metadata propagation without callable collapse;
  `TEST-MOD-REAL-005-CONSTRUCTOR-IMPORT-TRANSPORT` covers a qualified ordinary constructor import
  retaining its parent-scoped defining identity while transporting as constructor metadata through
  Core/CPS without installing authority;
  `TEST-MOD-REAL-005-PARENT-SCOPED-VISIBILITY-IMPORT-TRANSPORT` covers a checker-authorized
  `pub(super)` callable import retaining its defining identity, finalized private signature, and
  non-public Core/CPS visibility metadata without publishing a private binding;
  `TEST-MOD-REAL-005-PUBLIC-CALLABLE-REEXPORT-TRANSPORT` covers a public callable re-export chain
  retaining defining identity and visibility through Core/CPS metadata;
  `TEST-MOD-REAL-005-STRUCTURAL-REEXPORT-IDENTITY` covers that identity surviving a re-export
  through a nested structural-child path and a metadata-only facade;
  `TEST-MOD-REAL-005-REEXPORT-VISIBILITY-TRANSPORT` covers a parent-scoped re-export retaining
  the re-export's exact visibility in the Core/CPS import carrier rather than the provider's
  declaration visibility;
  `TEST-MOD-REAL-005-TYPE-FUNCTION-IMPORT-TRANSPORT` covers a public type-function namespace
  retaining metadata-only identity through Core/CPS import transport; mutation
...
`TEST-MOD-REAL-005-ENGINE-CHECKED-TRANSPORT`
  ...
  clients without creating a dependency edge; `TEST-MOD-REAL-005-REEXPORT-DEFINING-IDENTITY-FENCE` covers
  rejection when a re-export manufactures an identity absent from its canonical defining module;
  `TEST-MOD-REAL-005-UNDECLARED-IMPORT-DEPENDENCY-FENCE` covers rejection when a checked import
  target is present in the closure but absent from the importing interface's declared dependency
  snapshot; `TEST-MOD-REAL-005-UNDECLARED-EXPORT-DEPENDENCY-FENCE` covers the same dependency
  declaration fence for an external public re-export while preserving local and structural-child
  exports; `TEST-MOD-REAL-005-PUBLISHED-STRUCTURAL-CHILD-IMPORT` covers a valid public structural
  child import through the parent export, while `TEST-MOD-REAL-005-UNPUBLISHED-STRUCTURAL-CHILD-IMPORT`
  covers rejection of a child present in the graph but absent from the parent's public export view;
  `TEST-MOD-REAL-005-PARSER-IMPORT-PREAMBLE` covers parser-owned
  leading imports after crate-root metadata, `TEST-MOD-REAL-005-SCANNER-AUTHORITY-REJECTION`
  covers root export walking without nested inline-module flattening, while
  `TEST-MOD-REAL-005-LOCAL-IMPORT-NAMESPACE-KIND-FENCE` rejects a forged non-callable namespace
  kind on a same-module callable identity, and
  `TEST-MOD-REAL-005-VISIBILITY-IMPORT-FENCE` covers root visibility/import readers without
  nested inline re-export leakage; `TEST-MOD-REAL-005-SYNTHESIZED-METADATA-FENCE` covers the
  synthesized-runner metadata preprocessor retaining parser-owned inline module structure, while
  `TEST-MOD-REAL-005-MODULE-PARSE-FAIL-CLOSED` covers a module-shaped root whose canonical parse
  fails being rejected before the legacy loader can be selected, while preserving the
  non-module compatibility route; `TEST-MOD-REAL-005-PARSER-FAILURE-FALLBACK-AUTHORITY` covers
  the explicit non-authority fence
  for parser-failure metadata fallback and equivalent display-path cache aliases, while
  `TEST-MOD-REAL-005-BUILTIN-STDLIB-COMPATIBILITY` covers the narrow ordinary-loader exception
  for the configured built-in stdlib and byte-identical compatibility copies; the parser-backed
  `TEST-MOD-REAL-005-LEGACY-ENTRY-PRELUDE-COMPATIBILITY` and
  `TEST-MOD-REAL-005-ORDINARY-MISSING-ENTRY-COMPATIBILITY` witnesses preserve established bare
  entry diagnostics and the sealed provider/handler compatibility route without weakening
  explicit canonical roots.
  Normal metadata collection now consumes the complete parser-owned module result first; the
  metadata stripper remains only as an explicit parser-failure compatibility fallback; those
  records remain non-authorizing and cannot enter the canonical module closure.
  Lowerer-to-Engine wiring for remaining namespaces/dependencies, raw synthesized-pattern
  compatibility APIs, and parity beyond the bounded file/inline
  closure remain deferred; checked
  `TEST-MOD-REAL-005-PRIMITIVE-EXPRESSION-LOWERING` covers checked primitive arithmetic expression
  projection into Core/CPS; `TEST-MOD-REAL-005-MODULO-LOWERING` covers checked `%` lowering as
  `CorePrimOp::Rem` through Core typing, CPS, and Engine execution; `TEST-MOD-REAL-005-LET-EXPRESSION-LOWERING` covers a checked local
  literal binding and variable arithmetic projection into Core/CPS; `TEST-MOD-REAL-005-STRUCTURAL-FIELD-LOWERING`
  covers typed structural record construction and `RecordGet` projection into Core/CPS;
  `TEST-MOD-REAL-005-DECLARATION-ORDER-LOWERING` covers identity-keyed Core/CPS equality for
  equivalent declarations presented in different source orders;
  `TEST-MOD-REAL-005-IF-LET-LOWERING` covers boolean-literal `if let` projection, including
  false-pattern negation, into scoped Core `Not`/`If` and CPS;
  `TEST-MOD-REAL-005-SHORT-CIRCUIT-BOOLEAN-LOWERING` covers short-circuit `&&`/`||` lowering
  into Core `If` control flow, including boolean `Match` scrutinees and value-producing `let`
  initializers (`TEST-MOD-REAL-005-SHORT-CIRCUIT-BOOLEAN-LET-LOWERING`) and short-circuit
  `if let` scrutinees (`TEST-MOD-REAL-005-SHORT-CIRCUIT-BOOLEAN-IF-LET-LOWERING`) and callable
  arguments (`TEST-MOD-REAL-005-SHORT-CIRCUIT-BOOLEAN-ARGUMENT-LOWERING`) and boolean `match`
  scrutinee arguments (`TEST-MOD-REAL-005-SHORT-CIRCUIT-BOOLEAN-MATCH-ARGUMENT-LOWERING`);
  nested callable arguments containing short-circuit expressions are covered by
  `TEST-MOD-REAL-005-SHORT-CIRCUIT-NESTED-ARGUMENT-LOWERING`, which preserves the nested result
  through the enclosing value continuation; record construction fields containing a short-circuit
  expression are covered by `TEST-MOD-REAL-005-SHORT-CIRCUIT-RECORD-LOWERING`, which preserves
  field evaluation before structural projection;
  nested short-circuit operands are covered by
  `TEST-MOD-REAL-005-NESTED-SHORT-CIRCUIT-BOOLEAN-LOWERING`, which recursively preserves
  left-to-right boolean control flow;
  `TEST-MOD-REAL-005-MATCH-SCRUTINE-CALL-LOWERING` covers a checked callable boolean match
  scrutinee lowered through a scoped Core `LetCall` and `If`;
  `TEST-MOD-REAL-005-ORDINARY-ROOT-CANONICAL-ROUTE` covers a parseable root without structural
  children traversing the canonical source → finalization → Core/CPS → Engine route;
  `TEST-MOD-REAL-005-FILE-INLINE-LOWERING-PARITY` covers equal normalized
  Core/CPS closure facts across file and inline acquisition; `TEST-MOD-REAL-005-CHECKED-INTERFACE-CLOSURE` covers atomic projection of finalized public
  exports and parsed-import dependency identities into checked `PublicModuleInterface` values;
  `TEST-MOD-REAL-005-IMPLEMENTATION-METADATA-TRANSPORT` covers public implementation summaries
  ...
  checked-transport cache, while `TEST-MOD-REAL-005-LEGACY-PATH-CACHE-KEY` covers canonicalization
  of equivalent display paths in the remaining compatibility cache; the fallback-authority
...
**Canonical record status block:**
**Implementation:** implemented
**Evidence:** tested
**Parity:** matches_spec
**Layers:** type implemented; core implemented; cps implemented; admission-runtime not_applicable; verification implemented.
**Evidence detail:** TEST-MOD-REAL-005-FULL-DEFINITION-BODY-LOWERING; TEST-MOD-REAL-005-FULL-DEFINITION-BODY-CLOSURE; TEST-MOD-REAL-005-PARAMETERIZED-BODY-LOWERING; TEST-MOD-REAL-005-IMPORTED-CALL-LOWERING; TEST-MOD-REAL-005-IMPORTED-BUILTIN-CALLABLE-TRANSPORT; TEST-MOD-REAL-005-HANDLER-BODY-LOWERING; TEST-MOD-REAL-005-PARENT-SCOPED-CALLABLE-FENCE; TEST-MOD-REAL-005-REACHABLE-DEPENDENCY-CLOSURE; TEST-MOD-REAL-005-SELECTED-ENTRY-CLOSURE; TEST-MOD-REAL-005-SELECTED-ENTRY-SELECTION-ATOMICITY; TEST-MOD-REAL-005-ROUTE-CLOSURE-METADATA-CARRIER; TEST-MOD-REAL-005-ENGINE-CANONICAL-SOURCE-ROUTE; TEST-MOD-REAL-005-NEUTRAL-NONROOT-SELECTION; TEST-MOD-REAL-005-SUPPLIED-ROOT-SOURCE-AUTHORITY; TEST-MOD-REAL-005-FINALIZED-BODY-AUTHORITY; TEST-MOD-REAL-005-LET-EXPRESSION-LOWERING; TEST-MOD-REAL-005-STRUCTURAL-FIELD-LOWERING; TEST-MOD-REAL-005-MATCH-SCRUTINE-CALL-LOWERING; TEST-MOD-REAL-005-IMPORT-TRANSPORT; TEST-MOD-REAL-005-CONSTRUCTOR-IMPORT-TRANSPORT; TEST-MOD-REAL-005-REEXPORT-VISIBILITY-TRANSPORT; TEST-MOD-REAL-005-PARENT-SCOPED-VISIBILITY-IMPORT-TRANSPORT; TEST-MOD-REAL-005-PUBLIC-CALLABLE-REEXPORT-TRANSPORT; TEST-MOD-REAL-005-STRUCTURAL-REEXPORT-IDENTITY; TEST-MOD-REAL-005-PUBLISHED-STRUCTURAL-CHILD-IMPORT; TEST-MOD-REAL-005-TYPE-FUNCTION-IMPORT-TRANSPORT; TEST-MOD-REAL-005-IMPLEMENTATION-METADATA-TRANSPORT; TEST-MOD-REAL-005-TYPED-INTERFACE-IDENTITY; TEST-MOD-REAL-005-LOWERED-CLOSURE-HANDOFF; TEST-MOD-REAL-005-ENGINE-CHECKED-TRANSPORT; TEST-MOD-REAL-005-SAME-MODULE-LOCAL-CALL-CLOSURE; TEST-MOD-REAL-005-LEGACY-PATH-CACHE-KEY; TEST-MOD-REAL-005-BUILTIN-STDLIB-COMPATIBILITY; TEST-MOD-REAL-005-LEGACY-ENTRY-PRELUDE-COMPATIBILITY; TEST-MOD-REAL-005-ORDINARY-MISSING-ENTRY-COMPATIBILITY; TEST-MOD-REAL-005-BODY-LOWERING-REJECTION; TEST-MOD-REAL-005-PARSEABLE-CALLABLE-LOWERING-FAIL-CLOSED; TEST-MOD-REAL-005-PARSEABLE-CALLABLE-IMPORT-FAIL-CLOSED; TEST-MOD-REAL-005-SELECTED-ENTRY-PARENT-SCOPED-REJECTION; TEST-MOD-REAL-005-UNPUBLISHED-STRUCTURAL-CHILD-IMPORT; TEST-MOD-REAL-005-SINGLE-BODY-PARENT-SCOPED-REJECTION; TEST-MOD-REAL-005-SELECTED-ENTRY-CALLABLE-CYCLE-FENCE; TEST-MOD-REAL-005-PROVENANCE-REWRITE; TEST-MOD-REAL-005-CLOSURE-ATOMICITY; TEST-MOD-REAL-005-EXTRA-INTERFACE-CLOSURE-REJECTION; TEST-MOD-REAL-005-REEXPORT-DEFINING-IDENTITY-FENCE; TEST-MOD-REAL-005-PUBLIC-FUNCTION-COUNT-AUTHORITY; TEST-MOD-REAL-005-SCANNER-AUTHORITY-REJECTION; TEST-MOD-REAL-005-LOCAL-IMPORT-NAMESPACE-KIND-FENCE; TEST-MOD-REAL-005-PARSER-IMPORT-PREAMBLE; TEST-MOD-REAL-005-MODULE-PARSE-FAIL-CLOSED; TEST-MOD-REAL-005-VISIBILITY-IMPORT-FENCE; TEST-MOD-REAL-005-SYNTHESIZED-METADATA-FENCE; TEST-MOD-REAL-005-PARSER-FAILURE-FALLBACK-AUTHORITY; TEST-MOD-REAL-005-UNDECLARED-IMPORT-DEPENDENCY-FENCE; TEST-MOD-REAL-005-UNDECLARED-EXPORT-DEPENDENCY-FENCE.
**Parity evidence:** not applicable — Engine admission and client parity are separately owned by TASK-2063 and TASK-2064.
**Non-goal:** Engine-sealed linked admission, runtime execution, filesystem/text-scan authority, source rediscovery, direct-evaluator fallback, dynamic imports, runtime module values, or CLI/daemon parity.
**Next obligation:** None within Phase 207; preserve the non-authorizing builtin metadata fence and reject builtin calls before Engine admission. Host builtin dispatch, raw synthesized-pattern compatibility cleanup, and broader runtime work are follow-on exclusions.
...
- **Evidence detail:** `TEST-MOD-REAL-006-LINKED-CLOSURE` covers a shuffled complete canonical
  ...
  Core/CPS origin mismatch; `TEST-MOD-REAL-006-MALFORMED-CPS` covers malformed root CPS; and
  `TEST-MOD-REAL-006-PROVIDER-AUTHORITY-FENCE` covers rejection of provider CPS without frame
  installation; `TEST-MOD-REAL-006-ROOT-ENTRY-METADATA-FENCE` covers rejection of a root without
  selected checked-entry identity before sealing. `TEST-MOD-REAL-006-NON-CALLABLE-IMPORT-INVOCATION-FENCE`
  rejects a forged checked CPS call through a structural metadata import before admission can mint
  an execution route. `TEST-MOD-REAL-006-IMPORTED-CALLABLE-LINKING` is exercised by the real parser
  file/inline client-parity witness and covers selected-entry linking by defining identity and
  parameter metadata. `TEST-MOD-REAL-006-SELECTED-LOCAL-CLOSURE-FENCE` additionally rejects
  non-empty selected-entry metadata absent from the supplied checker-lowered local callable
  closure and rejects a non-callable namespace kind in a local closure entry.
  `TEST-MOD-REAL-006-SELECTED-PARAMETER-CLOSURE-FENCE` rejects selected parameter metadata that
  disagrees with the matched checker-lowered local callable entry. The focused
...
**Evidence:** tested
**Parity:** matches_spec
**Layers:** type not_applicable; core implemented; cps implemented; admission-runtime implemented; verification implemented.
**Evidence detail:** TEST-MOD-REAL-006-LINKED-CLOSURE; TEST-MOD-REAL-006-MISSING-FAILED-CLOSURE; TEST-MOD-REAL-006-MALFORMED-CPS; TEST-MOD-REAL-006-ROOT-ENTRY-METADATA-FENCE; TEST-MOD-REAL-006-SELECTED-LOCAL-CLOSURE-FENCE; TEST-MOD-REAL-006-SELECTED-PARAMETER-CLOSURE-FENCE; TEST-MOD-REAL-006-PROVIDER-AUTHORITY-FENCE; TEST-MOD-REAL-006-PROVENANCE-MUTATION.
**Parity evidence:** not applicable — The bounded Engine-sealed linked request and selected-entry callable linking are tested; real file/inline and CLI/daemon parity are supplied by TASK-2064 as the separate integration owner.
**Non-goal:** Treating TASK-2062 public Core/CPS carriers as sealed authority; raw/source or legacy ModuleGraph/module-loader import authority; parser/source rediscovery, text scans, or filesystem walking; direct-evaluator or alternate execution paths; provider/handler frame authority; dynamic imports, package/cache persistence, runtime module values, or CLI/daemon parity.
**Next obligation:** None within Phase 207; retain the Engine-only sealed request and reject raw-source, loader, direct-evaluator, and authority-installation alternatives.

## TASK-2064: Module Conformance and Client Parity

- **Task:** [TASK-2064](tasks/TASK-2064-module-conformance-and-client-parity.md)
- **Canonical owner:** `SPEC-103`, `MOD-REAL-001` through `MOD-REAL-006`, and the
  integration rule `SEM-MODULE-REALIZATION-006`.
**Implementation:** implemented
**Evidence:** tested
**Parity:** matches_spec
...
`TEST-MOD-REAL-CONFORMANCE-LET-LOWERING`; negative
  `TEST-MOD-REAL-CONFORMANCE-NEGATIVE`,
  `TEST-MOD-REAL-CONFORMANCE-BUILTIN-ADMISSION-FENCE`,
  `TEST-MOD-REAL-CONFORMANCE-STRUCTURAL-NEGATIVE`,
  `TEST-MOD-REAL-CONFORMANCE-VISIBILITY-NEGATIVE`,
  `TEST-MOD-REAL-CONFORMANCE-AMBIGUITY-NEGATIVE`,
  `TEST-MOD-REAL-CONFORMANCE-INVALID-REEXPORT-NEGATIVE`,
  `TEST-MOD-REAL-CONFORMANCE-NO-IMPLICIT-FLATTENING`,
  `TEST-MOD-REAL-CONFORMANCE-IMPORT-CYCLE-NEGATIVE`,
  `TEST-MOD-REAL-006-IMPORTED-CALLABLE-LINKING`, and
  `TEST-MOD-REAL-CONFORMANCE-LOCAL-CALL-CYCLE-NEGATIVE`;
  mutation `TEST-MOD-REAL-CONFORMANCE-MUTATION` and
...
`TEST-MOD-REAL-CONFORMANCE-RECORD-FIELD-CALL-PARITY` and
`TEST-MOD-REAL-CONFORMANCE-NESTED-RECORD-FIELD-CALL-PARITY`.
`TEST-MOD-REAL-CONFORMANCE-RECORD-FIELD-EXPRESSION-CALL-PARITY`.
`TEST-MOD-REAL-CONFORMANCE-DECLARATION-ORDER-PARITY`.
Production route evidence: `TEST-MOD-REAL-PRODUCTION-CLI-CANONICAL-ROUTE`,
...
`TEST-MOD-REAL-PRODUCTION-CLI-ORDINARY-ROOT`,
`TEST-MOD-REAL-PRODUCTION-DAEMON-ORDINARY-ROOT`,
...
- **Evidence detail:** the focused TASK-2064 target passes 59/59, including real parser →
  collection → finalization → Core/CPS → Engine-linked file/inline pair with equal normalized
  terminals, including an ordinary checked `fn main` multi-module entry, parameterized and multiple imported callables from one multi-function child, same-crate `pub(crate)`, parent-visible `pub(super)`, and canonical `pub(in crate...)` callable imports linked and executed through the checked route, public callable-import identity linked and executed through the checked route,
  local-literal-`let`, short-circuit-`let`, boolean-`if let`, short-circuit-`if let`, callable-argument, nested callable-argument, record-field, nested boolean, and `match`-argument short-circuit lowering, and short-circuit boolean lowering through both
  clients, transitive imported-call execution through both clients, public type re-export
  identity preservation through both clients, and a callable re-export through two public
  importing modules with original provider identity preserved, incomplete-closure rejection,
  and an ordinary callable reached through a nested public structural child with a
  metadata-only intermediate facade,
  explicit notation-import identity and syntax-phase metadata through both clients,
  ambiguous glob-import rejection before finalization,
  invalid public re-export rejection at a private provider boundary,
  and rejection of implicit child-export flattening,
  public interface plus non-callable implementation metadata carried through both clients,
  an imported public interface carried through the same route, same-module aliased private
  callable closure through both clients, imported public type metadata in a child callable
  signature, imported public constructor identity, effect-row metadata, type-function metadata,
  promoted-kind, proposition, evidence/law, nominal-newtype, and resource-type metadata through both clients, and imported macro expansion through both clients, recursive selected-entry alias rejection at the Engine
  cycle fence, provenance mutation rejection,
  an inline metadata property, and private-import visibility
  rejection before lowering. The shared TASK-2032 client suite passes 7/7. This is tested
  import-cycle rejection before finalization. This is tested evidence, not proof, and does not
  claim the remaining namespace/diagnostic matrix. The production `run` and daemon adapters now
...
**Evidence:** tested
**Parity:** matches_spec
**Layers:** type implemented; core implemented; cps implemented; admission-runtime implemented; verification implemented.
**Evidence detail:** TEST-MOD-REAL-CONFORMANCE-POSITIVE; TEST-MOD-REAL-CONFORMANCE-MAIN-PARITY; TEST-MOD-REAL-CONFORMANCE-PARAMETERIZED-CALL-PARITY; TEST-MOD-REAL-CONFORMANCE-MULTIPLE-IMPORTED-CALLABLES-PARITY; TEST-MOD-REAL-CONFORMANCE-CRATE-VISIBLE-CALLABLE-PARITY; TEST-MOD-REAL-CONFORMANCE-SUPER-VISIBLE-CALLABLE-PARITY; TEST-MOD-REAL-CONFORMANCE-RESTRICTED-VISIBLE-CALLABLE-PARITY; TEST-MOD-REAL-CONFORMANCE-LET-LOWERING; TEST-MOD-REAL-CONFORMANCE-TRANSITIVE-IMPORT; TEST-MOD-REAL-006-IMPORTED-CALLABLE-LINKING; TEST-MOD-REAL-PRODUCTION-CLI-CANONICAL-ROUTE; TEST-MOD-REAL-PRODUCTION-CLI-CANONICAL-INLINE-ROUTE; TEST-MOD-REAL-PRODUCTION-DAEMON-CANONICAL-ROUTE; TEST-MOD-REAL-PRODUCTION-DAEMON-CANONICAL-INLINE-ROUTE; TEST-MOD-REAL-PRODUCTION-DAEMON-CANONICAL-ROOT-INDEX; TEST-MOD-REAL-PRODUCTION-CLI-HANDLER-ONLY-CHILD; TEST-MOD-REAL-PRODUCTION-DAEMON-HANDLER-ONLY-CHILD; TEST-MOD-REAL-CONFORMANCE-NEGATIVE; TEST-MOD-REAL-CONFORMANCE-BUILTIN-ADMISSION-FENCE; TEST-MOD-REAL-CONFORMANCE-STRUCTURAL-NEGATIVE; TEST-MOD-REAL-CONFORMANCE-VISIBILITY-NEGATIVE; TEST-MOD-REAL-CONFORMANCE-AMBIGUITY-NEGATIVE; TEST-MOD-REAL-CONFORMANCE-INVALID-REEXPORT-NEGATIVE; TEST-MOD-REAL-CONFORMANCE-NO-IMPLICIT-FLATTENING; TEST-MOD-REAL-CONFORMANCE-IMPORT-CYCLE-NEGATIVE; TEST-MOD-REAL-CONFORMANCE-LOCAL-CALL-CYCLE-NEGATIVE; TEST-MOD-REAL-PRODUCTION-CLI-PARSEABLE-LOWERING-FAIL-CLOSED; TEST-MOD-REAL-PRODUCTION-DAEMON-PARSEABLE-LOWERING-FAIL-CLOSED; TEST-MOD-REAL-PRODUCTION-CLI-PARSEABLE-INVALID-IMPORT-FAIL-CLOSED; TEST-MOD-REAL-PRODUCTION-DAEMON-PARSEABLE-INVALID-IMPORT-FAIL-CLOSED; TEST-MOD-REAL-CONFORMANCE-MUTATION; TEST-MOD-REAL-CONFORMANCE-METADATA-PROPERTY; TEST-MOD-REAL-CLI-DAEMON-PARITY; TEST-MOD-REAL-PRODUCTION-CLI-CANONICAL-ROUTE; TEST-MOD-REAL-PRODUCTION-CLI-CANONICAL-INLINE-ROUTE; TEST-MOD-REAL-PRODUCTION-DAEMON-CANONICAL-ROUTE; TEST-MOD-REAL-PRODUCTION-DAEMON-CANONICAL-INLINE-ROUTE; TEST-MOD-REAL-PRODUCTION-DAEMON-CANONICAL-ROOT-INDEX; TEST-MOD-REAL-PRODUCTION-CLI-HANDLER-ONLY-CHILD; TEST-MOD-REAL-PRODUCTION-DAEMON-HANDLER-ONLY-CHILD; TEST-MOD-REAL-CONFORMANCE-CRATE-VISIBLE-CALLABLE-PARITY; TEST-MOD-REAL-CONFORMANCE-SUPER-VISIBLE-CALLABLE-PARITY; TEST-MOD-REAL-CONFORMANCE-RESTRICTED-VISIBLE-CALLABLE-PARITY; TEST-MOD-REAL-CONFORMANCE-MAIN-PARITY; TEST-MOD-REAL-CONFORMANCE-PARAMETERIZED-CALL-PARITY; TEST-MOD-REAL-CONFORMANCE-MULTIPLE-IMPORTED-CALLABLES-PARITY; TEST-MOD-REAL-006-IMPORTED-CALLABLE-LINKING; TEST-MOD-REAL-CONFORMANCE-REEXPORT-PARITY; TEST-MOD-REAL-CONFORMANCE-TRANSITIVE-REEXPORT-PARITY; TEST-MOD-REAL-CONFORMANCE-NESTED-STRUCTURAL-CALLABLE-PARITY; TEST-MOD-REAL-CONFORMANCE-STRUCTURAL-MODULE-ALIAS-PARITY; TEST-MOD-REAL-CONFORMANCE-NESTED-STRUCTURAL-MODULE-ALIAS-PARITY; TEST-MOD-REAL-CONFORMANCE-CANONICAL-SOURCE-REEXPORT-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPLEMENTATION-METADATA-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-INTERFACE-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-TYPE-SIGNATURE-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-CONSTRUCTOR-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-EFFECT-ROW-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-TYPE-FUNCTION-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-PROMOTED-KIND-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-PROPOSITION-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-EVIDENCE-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-MACRO-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-NEWTYPE-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-RESOURCE-PARITY; TEST-MOD-REAL-CONFORMANCE-TYPE-REEXPORT-PARITY; TEST-MOD-REAL-CONFORMANCE-NOTATION-IMPORT-PARITY; TEST-MOD-REAL-CONFORMANCE-SAME-MODULE-ALIAS-PARITY.
**Parity evidence:** TEST-MOD-REAL-CLI-DAEMON-PARITY; TEST-MOD-REAL-PRODUCTION-CLI-CANONICAL-ROUTE; TEST-MOD-REAL-PRODUCTION-CLI-CANONICAL-INLINE-ROUTE; TEST-MOD-REAL-PRODUCTION-DAEMON-CANONICAL-ROUTE; TEST-MOD-REAL-PRODUCTION-DAEMON-CANONICAL-INLINE-ROUTE; TEST-MOD-REAL-PRODUCTION-DAEMON-CANONICAL-ROOT-INDEX; TEST-MOD-REAL-PRODUCTION-CLI-HANDLER-ONLY-CHILD; TEST-MOD-REAL-PRODUCTION-DAEMON-HANDLER-ONLY-CHILD; TEST-MOD-REAL-CONFORMANCE-CRATE-VISIBLE-CALLABLE-PARITY; TEST-MOD-REAL-CONFORMANCE-SUPER-VISIBLE-CALLABLE-PARITY; TEST-MOD-REAL-CONFORMANCE-RESTRICTED-VISIBLE-CALLABLE-PARITY; TEST-MOD-REAL-CONFORMANCE-MAIN-PARITY; TEST-MOD-REAL-CONFORMANCE-PARAMETERIZED-CALL-PARITY; TEST-MOD-REAL-CONFORMANCE-MULTIPLE-IMPORTED-CALLABLES-PARITY; TEST-MOD-REAL-006-IMPORTED-CALLABLE-LINKING; TEST-MOD-REAL-CONFORMANCE-REEXPORT-PARITY; TEST-MOD-REAL-CONFORMANCE-TRANSITIVE-REEXPORT-PARITY; TEST-MOD-REAL-CONFORMANCE-NESTED-STRUCTURAL-CALLABLE-PARITY; TEST-MOD-REAL-CONFORMANCE-STRUCTURAL-MODULE-ALIAS-PARITY; TEST-MOD-REAL-CONFORMANCE-NESTED-STRUCTURAL-MODULE-ALIAS-PARITY; TEST-MOD-REAL-CONFORMANCE-CANONICAL-SOURCE-REEXPORT-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPLEMENTATION-METADATA-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-INTERFACE-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-TYPE-SIGNATURE-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-CONSTRUCTOR-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-EFFECT-ROW-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-TYPE-FUNCTION-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-PROMOTED-KIND-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-PROPOSITION-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-EVIDENCE-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-MACRO-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-NEWTYPE-PARITY; TEST-MOD-REAL-CONFORMANCE-IMPORTED-RESOURCE-PARITY; TEST-MOD-REAL-CONFORMANCE-TYPE-REEXPORT-PARITY; TEST-MOD-REAL-CONFORMANCE-NOTATION-IMPORT-PARITY; TEST-MOD-REAL-CONFORMANCE-SAME-MODULE-ALIAS-PARITY.
**Non-goal:** New module semantics, direct evaluators, provider/handler frame installation, daemon protocol redesign, package/cache persistence, or dynamic imports.
**Next obligation:** None within Phase 207; preserve the frozen callable-module file/inline and CLI/daemon parity boundary.

## TASK-2065: Module Realization Closeout

- **Task:** [TASK-2065](tasks/TASK-2065-module-realization-closeout.md)
- **Canonical owner:** `SPEC-103`, `MOD-REAL-001` through `MOD-REAL-006`, and the
  closeout rule `SEM-MODULE-REALIZATION-CLOSEOUT`.
  Canonical rule IDs: `SEM-MODULE-REALIZATION-001`, `SEM-MODULE-REALIZATION-002`,
  `SEM-MODULE-REALIZATION-003`, `SEM-MODULE-REALIZATION-004`,
  `SEM-MODULE-REALIZATION-005`, and `SEM-MODULE-REALIZATION-006`.
**Implementation:** implemented
**Evidence:** tested
**Parity:** matches_spec
- **Layers:** type implemented; core implemented; cps implemented; admission-runtime implemented;
...
- **Evidence identifiers:** positive `TEST-MOD-REAL-CLOSEOUT-CHECKER-CONTRACT` and
  ...
  `TEST-MOD-REAL-CLOSEOUT-SCANNER-INVENTORY`; mutation
  `TEST-MOD-REAL-CLOSEOUT-READINESS-GATE`; parity
  `TEST-MOD-REAL-CLOSEOUT-REFERENCE-BOUNDARY`.
- **Evidence detail:** `tools/docs/check_phase_207_closeout.py` validates the implementation,
  evidence, and parity axes for every module-realization record, active-task handoff records,
  the AUDIT-207 scanner inventory, and the module reference boundary. Its completion
  mode reports only the five frozen route-owner records (TASK-2073, TASK-2069, TASK-2063,
  TASK-2064, and TASK-2065); historical partial handoffs are not current blockers;
  `--require-complete` passes with the frozen route evidence and repository gates resolved.
...
**Parity:** matches_spec
**Layers:** type implemented; core implemented; cps implemented; admission-runtime implemented; verification implemented.
**Evidence detail:** TEST-MOD-REAL-CLOSEOUT-CHECKER-CONTRACT; TEST-MOD-REAL-CLOSEOUT-COMPLETION-SCOPE; TEST-MOD-REAL-CLOSEOUT-SCANNER-INVENTORY; TEST-MOD-REAL-CLOSEOUT-READINESS-GATE.
**Parity evidence:** not applicable — The closeout checker audits existing route evidence; it does not create a new execution or client-parity route.
**Non-goal:** Package/cache persistence, runtime module values, dynamic module loading, generalized runtime features, and raw synthesized-pattern compatibility APIs.
**Next obligation:** None within Phase 207; retain the documented boundaries for dynamic loading, generalized runtime features, and raw synthesized-pattern compatibility APIs.
...
**Historical successor ownership:** TASK-2068 is complete for its delivered foundation and TASK-2071
...
- **Historical successor obligation:** TASK-2074 completed expansion and TASK-2075 completed
...
- **Historical successor obligation:** The delivered M-GLOB/M-SUPER/M-GROUP/M-SIMPLE and related
...
- **Historical successor obligation:** TASK-2074 completed canonical expansion and TASK-2075 completed
  ...
  rule and atomic M-BIND publication; TASK-2073 completed definition/body checking and final
  interface/export closure. TASK-2069 then consumed only TASK-2073's complete checked handoff,
  and TASK-2064 supplied integration parity.
- **Record-mirrored next obligation:** TASK-2068 has no remaining implementation obligation:
  ...
  complete checked handoff; TASK-2063 consumed TASK-2069; TASK-2064 supplied integration parity;
  TASK-2065 supplied closeout inventory.
...
- **Historical layer status:** type partial; core not_applicable; cps not_applicable;
  admission-runtime not_applicable; verification partial. This is the pre-closeout handoff
  snapshot, not the current frozen-route result.
...
- **Handoff status:** Complete for the task-owned non-authorizing parsed-import/binding handoff at
  ...
  is not a Phase 207 completion blocker; current frozen-route verification is recorded by
  TASK-2065.
...
- **Status:** Complete for the frozen callable-module domain. It consumes TASK-2075's internal snapshot plus TASK-2072 staging and owns complete M-CHECK bodies,
  ...
  Type-layer file/inline final-interface parity. TASK-2069 consumes its complete checked handoff;
  TASK-2063 consumes TASK-2069's Engine closure; TASK-2064 owns executed/client parity.
- **Canonical rules:** `SEM-MODULE-REALIZATION-003`
- **Completion scope:** Finalization must propagate every public declaration needed by an importer
...
- **Imported type-function closure:** Public TypeFn equation/result names classify the
  type-computation namespace separately from ordinary type names. Explicitly imported public
  TypeFn dependencies must satisfy the same defining-module reachability and visibility checks;
  the retained TypeFn fact remains non-authorizing metadata. Positive evidence is
  `TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-FUNCTION-IMPORTED-DEPENDENCY`.
...
- **Implementation-proof export closure:** Nested proof parameter types, constraint arguments, explicit proof terms, and property strategies carried by public implementation summaries now use the same public dependency boundary; proofs remain parent-scoped and non-standalone. This is Type-layer, non-authorizing evidence.
- **Callable body handoff:** Ordinary callable declarations now retain their checker-owned body in the private checked view alongside signature, body span, and body type; public projections remain body-free. Invalid ordinary function bodies reject finalization atomically. Negative evidence is `TEST-MOD-REAL-003-TASK-2073-INVALID-FUNCTION-BODY`. This is Type-layer, non-authorizing evidence.
- **Constraint-expression closure:** Public interface laws, top-level laws, and top-level proofs now include constraint predicate arguments in value-callable export-closure checking. Private callable references in those constraints reject atomically. Negative evidence is `TEST-MOD-REAL-003-TASK-2073-PUBLIC-LAW-CONSTRAINT-PRIVATE-CALLABLE`, `TEST-MOD-REAL-003-TASK-2073-PUBLIC-INTERFACE-LAW-CONSTRAINT-PRIVATE-CALLABLE`, and `TEST-MOD-REAL-003-TASK-2073-PUBLIC-PROOF-CONSTRAINT-PRIVATE-CALLABLE`. This is Type-layer, non-authorizing evidence.
- **Implementation-member body closure:** Parent-scoped implementation methods and co-located handlers now retain checked signatures, body spans, and body types in the private view; co-located handlers also retain their typed clause facts for downstream lowering while remaining absent from standalone public callable exports. Positive evidence is `TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPLEMENTATION-METHOD-CHECKED-BODY` and `TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPLEMENTATION-HANDLER-CHECKED-BODY`. This is Type-layer, non-authorizing evidence.
- **Structural-module closure:** Public and private child-module declarations retain checked canonical child identities in the structural-module namespace; private children remain outside the external projection, while forged identities and missing collected targets reject atomically. Positive evidence is `TEST-MOD-REAL-003-TASK-2073-PUBLIC-STRUCTURAL-MODULE-FACT` and `TEST-MOD-REAL-003-TASK-2073-PRIVATE-STRUCTURAL-MODULE-FACT`; mutation evidence is `TEST-MOD-REAL-003-TASK-2073-STRUCTURAL-MODULE-CARRIER-FORGERY`. This is Type-layer, non-authorizing evidence.
- **Public type-alias closure:** Public mutually recursive ordinary type aliases are traversed through canonical TypeDomain/Interface identities and reject atomically with `CyclicPublicExportDependency`; recursive enum/struct bodies remain valid nominal recursion. Negative evidence is `TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-CYCLIC-DEPENDENCY`. This is Type-layer, non-authorizing evidence.
...
- **Public expression dependency closure:** Public law, policy, proof, and macro expression dependencies reject missing local/imported value callables and missing parent-scoped `Impl::operation` members before publication. Unknown/resource effect-row operation items retain
  their checker-owned non-authorizing semantics. Positive/negative evidence includes
  `TEST-MOD-REAL-003-TASK-2073-PUBLIC-MACRO-IMPORTED-CALLABLE-PUBLIC-DEPENDENCY` and
  `TEST-MOD-REAL-003-TASK-2073-PUBLIC-LAW-IMPORTED-IMPL-PRIVATE-MODULE-PATH`, plus
  `TEST-MOD-REAL-003-TASK-2073-PUBLIC-MACRO-MISSING-CALLABLE-DEPENDENCY` and
  `TEST-MOD-REAL-003-TASK-2073-PUBLIC-MACRO-MISSING-QUALIFIED-IMPL-OPERATION`.
...
- **Updated focused target:** The qualified namespace, implementation-call, qualified implementation-operation, where-bound, transitive-row, callable-whole-row, binding-metadata, forged-binding-shape, forged-local-name, forged declaration-metadata, forged imported implementation-operation, row-carrier shape precedence, staged public-use carrier, constructor-parent, implementation-proof, implementation-constraint-expression, parent-scoped implementation-member-body, ordinary-callable-body-carrier, structural-module, public type-alias cycle, structural-module carrier-forgery, generic-newtype-parameter, imported type-function dependency, and public-expression-dependency RED/GREEN slices leave the focused TASK-2073 integration target at 121/121, plus twenty-seven dedicated finalizer unit witnesses.
- The finalizer source contains twenty-seven `#[test]` unit witnesses; helper functions are not counted as witnesses.
- **Constructor evidence:** Positive `TEST-MOD-REAL-003-TASK-2073-PUBLIC-CONSTRUCTOR-PROJECTION`; negative/mutation `TEST-MOD-REAL-003-TASK-2073-CONSTRUCTOR-PRIVATE-PARENT-FORGERY` and `TEST-MOD-REAL-003-TASK-2073-CONSTRUCTOR-PARENT-IDENTITY-FORGERY` cover parent reachability and forged parent identity before public projection.
- **Generic newtype evidence:** Positive `TEST-MOD-REAL-003-TASK-2073-PUBLIC-GENERIC-NEWTYPE-PARAMETER` proves a public generic newtype's own representation parameter is not treated as an external export dependency.
- **Declaration-domain audit:** `CanonicalDeclarationKind::ALL` has 22 collection kinds; `Capability` is an atomic removed-syntax rejection, and the remaining 21 accepted kinds have finalizer support paths. Remaining namespace work is cross-kind closure/mutation completeness; parser-owned newtype interface-bound syntax is outside TASK-2073.
- **Implementation-proof evidence:** Negative `TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPLEMENTATION-PROOF-PRIVATE-TYPE` and `TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPLEMENTATION-PROOF-PRIVATE-CALLABLE` cover nested proof parameter and proof-term dependency closure before public implementation summary projection.
...
**Evidence:** tested
**Parity:** matches_spec
**Layers:** type implemented; core not_applicable; cps not_applicable; admission-runtime not_applicable; verification implemented.
**Evidence detail:** TEST-MOD-REAL-003-TASK-2073-CHECKED-PRIVATE-PUBLIC; TEST-MOD-REAL-003-TASK-2073-FINAL-PUB-USE; TEST-MOD-REAL-003-TASK-2073-GENERATED-CLOSURE-PROPERTY; TEST-MOD-REAL-003-TASK-2073-FILE-INLINE-FINAL-PARITY; TEST-MOD-REAL-003-TASK-2073-BUILTIN-PUBLIC-PROJECTION; TEST-MOD-REAL-003-TASK-2073-HANDLER-CHECKED-BODY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-CALLABLE-IMPORTED-SIGNATURE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-CALLABLE-IMPORTED-NEWTYPE-SIGNATURE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-CALLABLE-PROPOSITION-PUBLIC-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-QUALIFIED-ROW-PUBLIC-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-QUALIFIED-NOTATION-PUBLIC-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPORTED-NOTATION-PUBLIC-MODULE-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-PROJECTION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-IMPORTED-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-IMPORTED-PUBLIC-MODULE-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-DOMAIN-RESOURCE-NAMESPACE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-INTERFACE-PROJECTION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-SEALED-DOMAIN-PROJECTION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EFFECT-ROW-PROJECTION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-DATA-KIND-PREDICATE-PROJECTION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-FUNCTION-PROJECTION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-FUNCTION-IMPORTED-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-FUNCTION-PROPOSITION-TAIL-PROJECTION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-NOTATION-PROJECTION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-MACRO-SUMMARY-PROJECTION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EVIDENCE-PROJECTION; TEST-MOD-REAL-003-TASK-2073-IMPL-PROOF-LAW-PAIR; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPLEMENTATION-SUMMARY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPL-IMPORTED-PUBLIC-INTERFACE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPLEMENTATION-METHOD-CHECKED-BODY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPLEMENTATION-HANDLER-CHECKED-BODY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-STRUCTURAL-MODULE-FACT; TEST-MOD-REAL-003-TASK-2073-PRIVATE-STRUCTURAL-MODULE-FACT; TEST-MOD-REAL-003-TASK-2073-PUBLIC-INTERFACE-NESTED-EVIDENCE-VISIBILITY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPL-PROOF-VISIBILITY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-INTERFACE-LAW-PUBLIC-CALLABLE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-MODULE-LAW-PUBLIC-QUALIFIED-IMPL-CALL; TEST-MOD-REAL-003-TASK-2073-PUBLIC-MACRO-IMPORTED-CALLABLE-PUBLIC-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EFFECT-ROW-PUBLIC-QUALIFIED-IMPL-OPERATION; TEST-MOD-REAL-003-TASK-2073-FORGED-IMPORTED-IMPL-OPERATION-PUBLIC-MODULE-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPL-PUBLIC-WHERE-BOUND; TEST-MOD-REAL-003-TASK-2073-PUBLIC-USE-MODULE-PATH-CLOSURE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-USE-NARROW-REEXPORT-EXCLUSION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-USE-NARROW-REEXPORT-PROMOTION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-CONSTRUCTOR-PROJECTION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-GENERIC-NEWTYPE-PARAMETER; TEST-MOD-REAL-003-TASK-2073-EXPORT-CLOSURE-REJECTION; TEST-MOD-REAL-003-TASK-2073-INVALID-FUNCTION-BODY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-LAW-CONSTRAINT-PRIVATE-CALLABLE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-INTERFACE-LAW-CONSTRAINT-PRIVATE-CALLABLE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-PROOF-CONSTRAINT-PRIVATE-CALLABLE; TEST-MOD-REAL-003-TASK-2073-BUILTIN-PRIVATE-SIGNATURE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-FUNCTION-MISSING-SIGNATURE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-BUILTIN-MISSING-SIGNATURE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-HANDLER-MISSING-SIGNATURE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-CALLABLE-PROPOSITION-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-CALLABLE-PROPOSITION-PRIVATE-TYPE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-CALLABLE-PROPOSITION-PRIVATE-ROW; TEST-MOD-REAL-003-TASK-2073-PUBLIC-CALLABLE-PROPOSITION-PRIVATE-UNQUALIFIED-ROW; TEST-MOD-REAL-003-TASK-2073-PUBLIC-CALLABLE-PROPOSITION-IMPORTED-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-INTERFACE-LAW-PRIVATE-CALLABLE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-INTERFACE-LAW-IMPORTED-PRIVATE-CALLABLE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPORTED-ROW-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPORTED-DATA-KIND-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPORTED-NOTATION-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPORTED-NOTATION-PRIVATE-MODULE-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-IMPORTED-PRIVATE-MODULE-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-CALLABLE-IMPORTED-TYPE-PRIVATE-MODULE-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-MISSING-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-CYCLIC-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-NEWTYPE-MISSING-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-RESOURCE-MISSING-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-INTERFACE-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-INTERFACE-MISSING-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-SEALED-DOMAIN-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EFFECT-ROW-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-QUALIFIED-ROW-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EFFECT-ROW-TRANSITIVE-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EFFECT-ROW-CYCLIC-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EFFECT-ROW-MISSING-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-DATA-KIND-MISSING-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-PREDICATE-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-FUNCTION-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-FUNCTION-PATTERN-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-TYPE-FUNCTION-PROPOSITION-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-NOTATION-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-QUALIFIED-NOTATION-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-NOTATION-MISSING-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-MACRO-TYPED-SIGNATURE-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-MACRO-IMPORTED-CALLABLE-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-MACRO-MISSING-CALLABLE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-MACRO-MISSING-QUALIFIED-IMPL-OPERATION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EVIDENCE-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EVIDENCE-IMPORTED-CALLABLE-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPLEMENTATION-PRIVATE-DEPENDENCY; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPLEMENTATION-PROOF-PRIVATE-TYPE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPLEMENTATION-PROOF-PRIVATE-CALLABLE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-MODULE-LAW-PRIVATE-QUALIFIED-IMPL-CALL; TEST-MOD-REAL-003-TASK-2073-PUBLIC-LAW-IMPORTED-IMPL-PRIVATE-MODULE-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EFFECT-ROW-PRIVATE-QUALIFIED-IMPL-OPERATION; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EFFECT-ROW-MISSING-QUALIFIED-IMPL-OPERATION; TEST-MOD-REAL-003-TASK-2073-FORGED-IMPORTED-IMPL-OPERATION-PRIVATE-MODULE-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPL-PRIVATE-WHERE-BOUND; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPL-IMPORTED-PRIVATE-WHERE-BOUND; TEST-MOD-REAL-003-TASK-2073-PUBLIC-IMPL-MISSING-WHERE-BOUND; TEST-MOD-REAL-003-TASK-2073-AUTHORITY-FENCE; TEST-MOD-REAL-003-TASK-2073-PUBLIC-USE-PRIVATE-MODULE-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-USE-NESTED-PATH-DIAGNOSTIC; TEST-MOD-REAL-003-TASK-2073-PUBLIC-USE-NESTED-PRIVATE-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-USE-NESTED-PUB-CRATE-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-USE-NESTED-PUB-SUPER-PATH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-USE-NESTED-RESTRICTED-PATH; TEST-MOD-REAL-003-TASK-2073-CONSTRUCTOR-PRIVATE-PARENT-FORGERY; TEST-MOD-REAL-003-TASK-2073-STALE-ATOMICITY; TEST-MOD-REAL-003-TASK-2073-IMPORTED-BINDING-VISIBILITY-DRIFT; TEST-MOD-REAL-003-TASK-2073-IMPORTED-BINDING-MODULE-VISIBILITY-DRIFT; TEST-MOD-REAL-003-TASK-2073-IMPORTED-BINDING-SHAPE-MISMATCH; TEST-MOD-REAL-003-TASK-2073-PUBLIC-EFFECT-ROW-IMPORTED-BINDING-SHAPE-PRECEDENCE; TEST-MOD-REAL-003-TASK-2073-IMPORTED-BINDING-LOCAL-NAME-DRIFT; TEST-MOD-REAL-003-TASK-2073-IMPORTED-BINDING-DECLARATION-METADATA-DRIFT; TEST-MOD-REAL-003-TASK-2073-PUBLIC-USE-BINDING-CARRIER-DRIFT; TEST-MOD-REAL-003-TASK-2073-PUBLIC-USE-BINDING-METADATA-DRIFT; TEST-MOD-REAL-003-TASK-2073-CONSTRUCTOR-PARENT-IDENTITY-FORGERY; TEST-MOD-REAL-003-TASK-2073-STRUCTURAL-MODULE-CARRIER-FORGERY.
**Parity evidence:** not applicable — The Type-layer normalized file/inline final-interface projection is tested, but executed/client parity remains separately owned by TASK-2064.
**Non-goal:** No parser acquisition/graph construction, import grammar/binding ownership, Core/CPS lowering, Engine transport/link/admission/execution, direct evaluation, or CLI/daemon terminal parity.
**Next obligation:** None within Phase 207; preserve public identity, origin, visibility, checked metadata, and atomic export closure.
