...
|| [161](PLAN-161-CORE-ASH-IR-FOUNDATION.md) | 12 | 5 | 🚧 In progress; Core Ash AST carriers, `.core` fixture format, parser, and serializer slices complete; validator and Core-to-CPS lowering remain |
|
|---
...
**Status:** 🚧 In progress; 5/12 implemented
