        ...
        &[
            (
                ...
                &[
                    ...
                    "crates/ash-typeck/tests/alpha_visible_tower_manifest.rs",
            ...
            (
                "A69-9",
                &[
                    "crates/ash-cli/tests/alpha_ooda_library_demotion.rs",
            ...
            (
                "A69-11",
                &[
                    "crates/ash-typeck/tests/task_750_act_block_compat.rs",
                    "legacy_act_block_still_typechecks_and_carries_migration_diagnostics",
                ],
            ),
            (
                "A69-12",
...
#[test]
fn alpha_non_interference_matrix_covers_legacy_surfaces() {
    let audit = read_workspace_file("docs/plan/audits/TASK-931-alpha-acceptance-matrix.md");
    let spec069 =
        read_workspace_file("docs/spec/SPEC-069-ALPHA-VISIBLE-TOWER-ALGEBRA-AND-DO-LOWERING.md");
    ...
    assert_contains_all(
        ...
        &[
            ...
            "OODA demotion must not delete examples",
        ],
    );
    assert_contains_all(
    ...
    assert_contains_all(
        ...
        &[
            ...
            "registered_provider_without_admitted_binding_cannot_execute_through_invoke_fallback",
            "provider_in_act_env_without_runtime_state_binding_cannot_execute_through_invoke_fallback",
            "NI-5 OODA demotion preserves examples/docs",
