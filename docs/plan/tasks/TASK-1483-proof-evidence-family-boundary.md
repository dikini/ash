# TASK-1483: Define future proof evidence family boundary

## Status: ⏸️ Deferred / To-Spec

## Description

Document how future `by symbolic`, `by solver`, and proof-producing synthesis differ from empirical `by test` evidence.
...
- TASK-1482 complete or explicitly handed off
