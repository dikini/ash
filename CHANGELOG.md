...
- [Phase 161](docs/plan/PLAN-161-CORE-ASH-IR-FOUNDATION.md): Planned Core Ash IR foundation with dedicated Core AST carriers, strict `.core` fixture/debug text format, parser/serializer round-trips, Core validation, and Core-to-CPS lowering tasks. Surface-to-Core lowering and ad-hoc polymorphism remain out of scope. (TASK-1620 through TASK-1631)
