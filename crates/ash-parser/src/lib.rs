...
pub use canonical_syntax_dependencies::{
    ...
    CanonicalNotationImportFailureKind, CanonicalNotationKey, CanonicalNotationPatternPart,
    CanonicalNotationSummary, CanonicalSyntaxDependencyCycle, CanonicalSyntaxDependencyEdge,
    CanonicalSyntaxImport, CanonicalSyntaxImportFailure, CanonicalSyntaxImportFailureKind,
    CanonicalSyntaxProviderFailure,
};
