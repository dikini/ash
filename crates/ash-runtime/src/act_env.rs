...
impl ActEnv {
    ...
    pub fn new(capability_ctx: CapabilityContext, provenance: Provenance) -> Self {
        Self {
            capability_ctx,
            provenance,
            effects: Vec::new(),
    ...
    /// that state.
    pub async fn from_runtime_state(runtime_state: &RuntimeState, provenance: Provenance) -> Self {
        let capability_ctx = runtime_state.create_capability_context().await;
        Self::new(capability_ctx, provenance)
    }
    ...
    pub async fn from_runtime_state_with_admitted_bindings(
        ...
        let capability_ctx = runtime_state
            ...
            .await?;
        Ok(Self::new(capability_ctx, provenance))
    }
...
impl Default for ActEnv {
    fn default() -> Self {
        Self::new(CapabilityContext::new(), Provenance::default())
    }
}
