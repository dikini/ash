    # TASK-735: Add runtime carriers for resource instances, resource identity, lifecycle, access policy, and provenance metadata.
    ...
    Add runtime carriers for resource instances, resource identity, lifecycle, access policy, and provenance metadata.
...
- SPEC-051
    ...
    - ✅ TASK-734: prerequisite task

    ## Requirements

    ### Functional Requirements

    1. Define ResourceId and ResourceTypeId carriers.
2. Define ResourceInstance lifecycle and owner metadata.
3. Define access and split/join policy enums for the MVP.
4. Expose runtime lookup/storage APIs without wiring capability execution yet.
    ...
    - Runtime can represent Ash-owned resource instances.
