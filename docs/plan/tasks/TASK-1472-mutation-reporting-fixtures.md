...
Add no-Cargo fixtures proving killed and survived mutants appear in JSON output with source spans and replay hints.
...
- TASK-1471 complete or explicitly handed off
