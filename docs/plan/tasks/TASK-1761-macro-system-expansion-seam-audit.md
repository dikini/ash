...
Audit the Phase 172 implementation and decide whether summary import, token-tree parsing, binder hygiene, and typed macros can safely remain one implementation phase or must split before coding.
