...
| [TASK-1501](tasks/TASK-1501-quickcheck-with-override-parser-typecheck.md) | Make `by test property` / `quickcheck` first-class proof evidence: extend parser, AST, and runner schema with source-visible `Strategy<T>` overrides; `property` and `quickcheck` are synonymous. | 📝 Planned |
| [TASK-1502](tasks/TASK-1502-quickcheck-combinators-recursion-and-weights.md) | Implement function-based combinators: choice, weighted choice, map/project helpers, shrink wrappers, and bounded recursion. | 🚧 Partial / Stdlib Surface Complete |
...
| [TASK-1506](tasks/TASK-1506-quickcheck-v1-closeout-and-review.md) | Close out Phase 151 with broad verification, independent review, status reconciliation, and changelog/reference updates. | 📝 Planned |
