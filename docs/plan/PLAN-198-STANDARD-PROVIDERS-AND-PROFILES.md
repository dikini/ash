...
|------|-------------|----------|------------|--------|
| [TASK-1934](tasks/TASK-1934-standard-providers-profiles-plan-packet.md) | Create the Phase 198 plan and task packet | 2h | Phase 197 | Planned |
| [TASK-1935](tasks/TASK-1935-standard-provider-profile-audit.md) | Audit stdlib provider modules, runtime providers, examples, and profile seams | 6h | TASK-1934 | Planned |
...
| [TASK-1940](tasks/TASK-1940-common-row-admission-profiles.md) | Add common row/admission profile definitions and validation fixtures | 12h | TASK-1936, TASK-1937, TASK-1938, TASK-1939 | Planned |
