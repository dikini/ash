...
- [TASK-807](docs/plan/audits/TASK-807-sealed-domain-audit.md): Phase 111 sealed-domain audit gate. Authoritative audit of the live parser/core/engine/typechecker substrate documenting current declaration carriers, summary transport, kind ownership, import/export behavior, and registration seams. Identifies 7 contradictions between current code and SPEC-059 requirements, maps exact file targets for TASK-808 through TASK-813, and explicitly marks deferred work belonging to SPEC-D/E/F/G/H.
