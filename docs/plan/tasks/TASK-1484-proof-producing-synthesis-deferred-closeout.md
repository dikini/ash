# TASK-1484: Close deferred todo-spec packet

## Status: ⏸️ Deferred / To-Spec

## Description

Update PLAN-INDEX/CHANGELOG/reference caveats and leave explicit to-spec criteria for a future implementation phase.
...
- TASK-1483 complete or explicitly handed off
