...
| [TASK-2069](tasks/TASK-2069-complete-module-lowering-and-engine-transport-fencing.md) | Implement complete definition-body lowering and Engine scanner/path-cache transport fencing | In progress — partial/tested/below-spec; bounded finalized-body and atomic per-function closure lowering are delivered; 10/10 focused tests now cover callable/structural resolved-import identity/origin transport, explicit rejection of unsupported namespaces, and atomic carrier mismatch rejection; remaining namespaces, dependency closure, and Engine fencing remain open; consumes TASK-2073 and is the immediate TASK-2063 prerequisite |
