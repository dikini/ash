...
while a selected-provider descendant reaches the anchored provider-leaf shape rejection. It
  ...
  expansion, TASK-2075 is active for two-tier collection, TASK-2072 for complete parsed imports/binding, and
...
- **Additional bounded callable proposition-tail closure evidence:** The focused target now passes
  67/67. Public callable tails retain public predicate dependencies; private local/imported tail
...
- **Updated focused target:** The qualified implementation-call RED/GREEN pair brings the focused TASK-2073 target to 72/72.
