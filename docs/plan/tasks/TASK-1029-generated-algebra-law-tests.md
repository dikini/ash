...
Implement generated algebra law tests for the public `std::algebra` interfaces using the SPEC-077 generated-test runner framework. This task consumes the handoff from TASK-1026 and turns law profiles into executable generated tests.
...
1. Add generated-test law profile data structures for Semigroup, Monoid, Functor, Applicative, and Monad.
