...
| [SPEC-063](SPEC-063-ASSOCIATED-TYPE-FAMILY-COMPUTATION.md) | Associated Type-Family Computation | Draft / Ready | DESIGN-034 SPEC-G: plans sealed associated type-family computation over the total type-computation substrate, preserving SPEC-035 simple substitution while adding explicit family projections, unique generic impl-family reduction, rigid where-bound projections, recursive family totality, V4 public family summaries, diagnostics, and non-inversion boundaries. |
