...
Add deterministic shard descriptors, test IDs, seed assignment, and result merge IDs without requiring remote workers.
...
- TASK-1477 complete or explicitly handed off
