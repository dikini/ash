...
| [TASK-872](tasks/TASK-872-proposition-layer-audit-gate.md) | Audit live parser/core/typeck/normalizer/engine proposition seams and bind downstream tasks before Rust changes | Docs/Substrate | 5 | 🟡 Ready |
...
- [ ] TASK-872 audit artifact created before Rust implementation and downstream TASK-873 through TASK-882 file/test/callsite bindings patched or explicitly confirmed.
