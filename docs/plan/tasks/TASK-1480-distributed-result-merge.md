...
Merge multiple shard JSON files deterministically, detecting duplicate/missing shard/test IDs and preserving evidence artifacts.
...
- TASK-1479 complete or explicitly handed off
