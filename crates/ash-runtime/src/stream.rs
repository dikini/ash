...
impl StreamContext {
    ...
    ///
    /// ```
    /// use ash_runtime::stream::{StreamContext, MockStreamProvider};
    /// use ash_runtime::TypedStreamProvider;
    /// use ash_runtime::stream::StreamProvider;
    /// use ash_typeck::Type;
    ///
    ...
    ///
    /// ```
    /// use ash_runtime::stream::{StreamContext, MockStreamProvider, StreamProvider};
    /// use ash_runtime::TypedStreamProvider;
    /// use ash_core::Value;
    /// use ash_typeck::Type;
    ///
...
///
/// ```
/// use ash_runtime::stream::{StreamProvider, SendableStreamProvider, MockSendableProvider};
/// use ash_core::Value;
///
...
pub trait SendableStreamProvider: StreamProvider + Send + Sync {
    ...
    ///
    /// ```
    /// use ash_runtime::stream::{SendableStreamProvider, MockSendableProvider};
    ///
    /// let provider = MockSendableProvider::new("queue", "output");
...
///
/// ```
/// use ash_runtime::stream::{SendableStreamProvider, MockSendableProvider, TypedSendableProvider};
/// use ash_core::Value;
/// use ash_typeck::Type;
///
/// # let runtime = tokio::runtime::Builder::new_current_thread().enable_all().build().unwrap();
...
impl TypedSendableProvider {
    ...
    ///
    /// ```
    /// use ash_runtime::stream::{MockSendableProvider, TypedSendableProvider};
    /// use ash_typeck::Type;
    ///
    /// let inner = MockSendableProvider::new("queue", "output");
    /// let typed = TypedSendableProvider::new(inner, Type::Int);
...
///
/// ```
/// use ash_runtime::stream::{BidirectionalStreamProvider, MockBidirectionalStream};
/// use ash_runtime::stream::{StreamProvider, SendableStreamProvider};
/// use ash_core::Value;
/// use ash_typeck::Type;
///
/// # let runtime = tokio::runtime::Builder::new_current_thread().enable_all().build().unwrap();
...
///
/// ```
/// use ash_runtime::stream::{BidirectionalStream, MockBidirectionalStream};
/// use ash_core::Value;
///
/// # let runtime = tokio::runtime::Builder::new_current_thread().enable_all().build().unwrap();
/// # runtime.block_on(async {
