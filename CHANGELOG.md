...
- [TASK-942](docs/plan/tasks/TASK-942-phase123-postmerge-runtimekernel-remediation.md): Reopened Phase 123 post-merge remediation for RuntimeKernel admission/report lifecycle, daemon admitted-artifact execution lifetime, binding-ID admission facts, empty-admission fail-closed authority, binding alias projection tests, and SPEC-070 artifact-equivalence wording.
