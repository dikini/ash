...
3. Add explicit parse rejection coverage for deferred holes, partial type-constructor application, or alternative projection spellings if those paths are encountered.
4. Do not add public `type fn`, kind binder syntax, or sealed-domain syntax.
...
2. Write failing parser tests for explicit rejection of deferred syntax shapes touched by this task.
...
Single-crate task. Keep public syntax expansion strictly out of scope.
