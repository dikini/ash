...
- Add declared-corpus property tests for focused same-admitted-program REPL–Engine
...
3. Add a focused normalized-terminal comparison for the same admitted source through REPL and
   Engine.
...
**Does not own:** TASK-2041's four-client same-admitted-program terminal comparison.

**Integration/proof responsibility:** TASK-2039 owns focused REPL-to-Engine observations for the
selected controls. TASK-2041 separately compares the shared admitted program across all four
clients.
...
- `TEST-TASK-2039-REPL-MULTILINE` (**Positive**): the selected multiline source remains a client input concern
  and reaches the same admitted route after completion.
