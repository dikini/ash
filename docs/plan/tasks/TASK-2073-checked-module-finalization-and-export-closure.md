...
checker-owned;
public effect-row role items now apply the same staged local, imported, and qualified visibility
check while retaining roles as minimum namespace metadata only;
