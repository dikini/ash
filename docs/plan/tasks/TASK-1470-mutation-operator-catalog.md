...
Specify and implement safe first-slice pure-expression mutations such as boolean flip, equality inversion, integer boundary perturbation, and branch replacement.
...
- TASK-1469 complete or explicitly handed off
